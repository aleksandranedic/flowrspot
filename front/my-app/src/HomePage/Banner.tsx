    ...
    return (
        <div className='relative'>
            <div className={`w-full h-fit`}>
                <img src="../images/banner.png" alt='banner' className={`banner ${loged ? "!opacity-0 !h-52" : "!opacity-100"}`}/>
            </div>
            <div className={`banner-text flex flex-col items-center w-full justify-center ${loged ? "hidden" : "block"}`}>
