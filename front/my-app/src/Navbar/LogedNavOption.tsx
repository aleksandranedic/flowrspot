...
const LogedNavOption: React.FunctionComponent<LogedNavOptionProps> = ({name, navbarOpen}) => {
    ...
    return ( 
        <div className='flex items-center justify-start gap-2'>
            ...
            <div className={`flex-col gap-2 absolute top-44 left-1 lg:top-12 lg:left-auto w-36 bg-white ${open ? 'flex' : 'hidden'}`}>
                <p className='gray-text cursor-pointer border-b-2 w-full p-2 pr-4 !flex !justify-end' onClick={() => {setOpenProfile(!openProfile); navbarOpen(false)}}>Profile</p>
